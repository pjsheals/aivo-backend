...
// MUST happen before probe run check — PSOS creates no probe_runs by design
...
// ── Get probe runs — BJP instruments only ─────────────────────────
...
try {
    ...
    $ditChatgpt = $ditGemini = $ditPerplexity = $ditGrok = null;
